package com.besthotel.hotel.model;
...
public class Hotel {
    ...
    public Hotel(String fromDate, String toDate, String city, Integer numberOfAdults, String provider, String hotelName, BigDecimal farePerNight, String amenities, Float rate, Integer discount) {
